        ...
        @php
            $faqs = [
                [
                    ...
                    'a' =>
                        'Tidak selalu sama, namun estimasi yang diberikan cukup mendekati. Setiap leasing memiliki kebijakan bunga dan biaya tambahan yang berbeda.',
                ],
                [
                    'q' => 'Apa perbedaan bunga flat dan efektif?',
                    'a' =>
                        'Bunga flat dihitung dari pokok awal selama tenor. Bunga efektif dihitung dari sisa pokok, sehingga total bunga lebih kecil namun cicilan awal lebih tinggi.',
                ],
                [
                    'q' => 'Berapa kisaran DP untuk kredit mobil?',
                    'a' =>
                        'Umumnya berkisar antara 10% hingga 30% dari harga kendaraan, tergantung kebijakan leasing dan jenis kendaraan.',
                ],
            ];
        @endphp
