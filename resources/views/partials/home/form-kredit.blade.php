    ...
    <form id="form-kredit" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" id="harga_mobil_display" placeholder="0"
        ...
        <div>
            ...
            <div class="relative">
                <input type="text" name="dp" id="dp" placeholder="0" maxlength="5"
        ...
        <div>
            ...
            <div class="relative">
                <input type="text" name="tenor" id="tenor" placeholder="0" maxlength="2"
        ...
        <button type="submit" id="btn-submit"
            ...
            <span id="btn-loading" class="hidden items-center justify-center gap-2">
                <svg class="animate-spin w-4 h-4 text-black" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24">
...
<script>
    ...
    document.getElementById('form-kredit').addEventListener('submit', async function(e) {
        ...
        ['harga_mobil', 'dp', 'tenor'].forEach(field => {
            ...
            const inpEl = document.getElementById(field) ?? document.getElementById(
                'harga_mobil_display');
            errEl.textContent = '';
