...
<section class="relative overflow-hidden py-32 flex items-center justify-center bg-[#0D0D0D]">
    ...
    <div class="absolute inset-0 z-0">
        ...
        {{-- Glow Efek --}}
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#E8FF47]/10 blur-[120px] rounded-full">
        </div>
    </div>

    {{-- 2. Floating Elements (Biar gak monoton) --}}
    <div class="absolute hidden md:block w-24 h-24 border border-[#E8FF47]/20 rounded-full top-20 left-20 animate-bounce" style="animation-duration: 6s;"></div>
    <div class="absolute hidden md:block w-32 h-32 border border-white/5 rounded-3xl bottom-10 right-20 animate-spin" style="animation-duration: 15s;"></div>
    ...
    <div class="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <h1 class="text-5xl md:text-7xl font-black tracking-tight leading-[1.1] mb-8 text-white" 
            ...
            <span class="relative">
                ...
                <svg class="absolute -bottom-2 left-0 w-full" height="8" viewBox="0 0 300 8" fill="none" preserveAspectRatio="none">
...
{{-- Pastikan Tailwind config atau CDN kamu mendukung animasi standar, atau tambahkan CSS ini --}}
<style>
